...
namespace Horyzen::Geo {
	...
	class NURBSSurfaceBuilder2 : public AbstractSurfaceBuilder
	{
	public:

		NURBSSurfaceBuilder2(std::shared_ptr<NURBSSurface> p_surfaceObject);
		virtual ~NURBSSurfaceBuilder2() = default;
